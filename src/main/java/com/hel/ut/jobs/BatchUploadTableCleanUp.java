 ...
 * @author chadmccue
 */
public class BatchUploadTableCleanUp implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        try {
            ...
            transactionInManager.batchUploadTableCleanUp();
        } catch (Exception ex) {
        	try {
            	try {
                	/* Send Email to admin*/
                    ...
                    messageDetails.setmessageSubject("BatchUploadTableCleanUp job error - " + System.getProperty("server.identity"));
