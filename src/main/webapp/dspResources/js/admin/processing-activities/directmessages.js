    ...
    function populateMessages(fromDate,toDate) {
        ...
        $('#directmessagesin-table').DataTable().destroy();
         ...
         $('#directmessagesin-table').DataTable({
            ...
            oLanguage: {
               sEmptyTable: "There were no inbound direct messages for the selected date range.", 
               sSearch: "_INPUT_",
            ...
            aoColumns: [
                ...
                },
                {
                    ...
                    "render": function ( data, type, row, meta ) {
                        if(data != '') {
                            return '<a href="/administrator/configurations?i=' + row.configId + '" title="View Configuration">' + row.configName + '</a>';
                        }
                        else {
                            return "N/A";
                        }
                ...
                },
                {
                    ...
                    "render": function ( data, type, row, meta ) {
                        if(row.systemName != '') {
                            return data + '<br /><br />System: ' + row.systemName;
                        }
                        else {
                            return data;
                        }
