...
<aside class="secondary">
    <nav class="secondary-nav" role="navigation">
        <ul class="nav nav-pills nav-stacked">
            <li ${param['page'] == 'crosswalks' ? 'class="active"' : ''}><a href="<c:url value='/administrator/sysadmin/crosswalks'/>" title="Standard Crosswalks">Standard Crosswalks</a></li>
	    ...
	    <li ${param['page'] == 'hisps' ? 'class="active"' : ''}><a href="<c:url value='/administrator/sysadmin/hisps'/>" title="Hisps">View HISPS</a></li>
            ...
            <c:if test="${userDetails.email == 'cmccue@health-e-link.net' || userDetails.email == 'gchan@health-e-link.net'}">
                <li ${param['page'] == 'getLog' ? 'class="active"' : ''}>
                    <a href="<c:url value='/administrator/sysadmin/getLog'/>" title="Download Log">Download Log</a>
                </li>
            </c:if>
